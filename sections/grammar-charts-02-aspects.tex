...
Closed syllable roots generally have \fm{-μH} stem variation except for when they occur in motion verbs with one of the preverbs \fm{kei=} ‘up’, \fm{yei=} ‘down’, \fm{ÿeeḵ=} \~\ \fm{ÿeiḵ=} ‘beach’, \fm{daaḵ=} ‘inland’, \fm{daak=} ‘out to sea’, and \fm{g̱unaÿéi=} \~\ \fm{g̱unéi=} ‘beginning, starting’.
In these contexts the imperative form with a closed syllable root will have \fm{-μμL} (with \fm{\rt{CVC}}) or \fm{-μμH} (with \fm{\rt{CVCʼ}} or \fm{\rt{CVʼC}}) stem variation instead \parencites[176]{story:1966}[209]{leer:1991}.
